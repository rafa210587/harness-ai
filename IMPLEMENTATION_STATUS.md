...
| 20 | Packaging + v1 acceptance | Partial | CLI package entrypoint and core suite pass on both Linux and Windows GitHub runners; local acceptance script exists | Real host/app acceptance suite + cross-application flows |
...
Windows local acceptance PowerShell script
```
...
The core is validated through Level 4. Levels 5–6 are the next meaningful gates.
