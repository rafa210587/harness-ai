...
export function canonicalize(candidate, root) {
...
export function isSensitive(candidate) {
...
export function pathArgs(tool, args) {
  switch (tool) {
    case "read":
    case "write":
    case "edit":
...
export function assertSafePath(tool, rawPath, root) {
...
export function assertSafeSearch(tool, args) {
...
export function assertSafeBash(tool, args) {
